---
name: modscape-spec-explain
description: Explain the content of a spec work folder for handoff or onboarding — overview, key decisions, and remaining tasks.
---
...
## COMMAND: /modscape:spec:explain

Usage: `/modscape:spec:explain <name>`
