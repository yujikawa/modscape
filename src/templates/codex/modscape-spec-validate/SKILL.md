---
name: modscape-spec-validate
description: Check cross-artifact consistency across all SDD documents in a work folder and report mismatches, gaps, and drift by category.
---
...
## COMMAND: /modscape:spec:validate

Usage: `/modscape:spec:validate <name>`
