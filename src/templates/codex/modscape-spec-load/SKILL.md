---
name: modscape-spec-load
description: Load a previously saved session state from session.md into the current conversation. Deletes the file after loading.
---
