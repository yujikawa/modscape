...
3. Build and display the review summary:
   ...
   **AC Coverage**: for each `AC-NNN:` in spec.md:
   ...
   - 🔧 Manual verification — `[manual verification]` marker
...
4. If no issues: `✅ No open issues. Ready to implement.`
...
## COMMAND: /modscape:spec:review

Usage: `/modscape:spec:review <name>`
